...
const ROWS = [
  ...
  {
    eyebrow: "Payroll",
    title: "Salaries and payslips, sorted",
    body: "Run salary requests, approvals, payroll, and payslips for your whole team — with role-aware workflows, in one place.",
    points: ["Salary requests & approvals", "Payroll runs and payslips", "Role-based permissions"],
    Panel: PanelPayroll,
    url: "app.buildally.in/payroll",
  },
  {
    eyebrow: "Documents",
